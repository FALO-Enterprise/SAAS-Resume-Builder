...
const featureColors = [
  { accent: '#f5a623', bg: 'from-[#f5a623]/15 to-transparent', border: 'hover:border-[#f5a623]/30' },
  { accent: '#3b82f6', bg: 'from-[#3b82f6]/15 to-transparent', border: 'hover:border-[#3b82f6]/30' },
  { accent: '#14b8a6', bg: 'from-[#14b8a6]/15 to-transparent', border: 'hover:border-[#14b8a6]/30' },
  { accent: '#a855f7', bg: 'from-[#a855f7]/15 to-transparent', border: 'hover:border-[#a855f7]/30' },
  { accent: '#f43f5e', bg: 'from-[#f43f5e]/15 to-transparent', border: 'hover:border-[#f43f5e]/30' },
  { accent: '#22c55e', bg: 'from-[#22c55e]/15 to-transparent', border: 'hover:border-[#22c55e]/30' },
];
