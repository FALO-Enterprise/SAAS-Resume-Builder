...
// import {
//   resetPassword as resetPasswordWithBackend,
//   validateResetToken as validatePasswordResetToken,
// } from "@/lib/api/auth";
...
import PasswordStrength from "@/lib/utilities/PasswordStrength";
import Logo from "@/components/ui/Logo";
import ResetPasswordSkeleton from "@/components/ui/ResetPasswordSkeleton";
import { useResetPasswordFlow } from "@/hooks/mutations/useResetPasswordFlow";
...
function ResetPasswordContent() {
  ...
  const { tokenStatus, submit, isPending, generalError, success } =
    useResetPasswordFlow(token, t("errors.network"));
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    if (tokenStatus !== "valid" || !validate()) return;
    await submit(password, t("errors.resetFailed"));
  };
            ...
            >
              ...
              <div className="mb-5 flex flex-col gap-2">
                <AuthInput
                  ...
                  rightSlot={eyeButton(showPassword, () => setShowPassword((c) => !c))}
                />
                <PasswordStrength password={password} />
              </div>
              ...
              <div className="mb-8">
                <AuthInput
                  ...
                  rightSlot={eyeButton(showConfirm, () => setShowConfirm((c) => !c))}
                />
              </div>
