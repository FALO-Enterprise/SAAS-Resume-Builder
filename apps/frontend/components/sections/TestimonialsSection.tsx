...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="section-padding relative">
      ...
      <div className="absolute top-0 right-0 w-80 h-80 bg-gold-dark/10 blur-[80px] rounded-full" />
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {testimonials.map((item, i) => (
            <motion.div
              ...
              className="glass rounded-2xl p-7 border border-edge hover:border-edge-strong duration-300 group hover:-translate-y-1 flex flex-col"
            >
              {/* Quote icon */}
              ...
              {/* Text */}
              <p className="text-secondary leading-relaxed flex-1 mb-8">
                `{item.text}`
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="ms-auto glass text-faint text-xs px-2 py-1 rounded-full border border-edge shrink-0">
                  {item.region}
                </div>
              </div>
            </motion.div>
